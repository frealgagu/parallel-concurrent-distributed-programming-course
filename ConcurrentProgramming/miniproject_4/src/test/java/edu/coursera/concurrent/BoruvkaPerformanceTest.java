...
public class BoruvkaPerformanceTest extends TestCase {
    ...
    private static final double expectedSpeedup = 1.7;
    ...
    private static class ExperimentResults {
        ...
        final long totalEdges;
        final double totalWeight;

        ExperimentResults(final double elapsedTime, final long totalEdges, final double totalWeight) {
    ...
    private static <C extends Component<C>, E extends Edge<C>> ExperimentResults driver(
        ...
        return new ExperimentResults(
                minElapsed,
                finalSolution.getSolution().totalEdges(),
